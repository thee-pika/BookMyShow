    ...
    return (
        <div>
            <div className=" bg-white rounded-xl shadow-md  ">
                <h1 className="text-xl font-bold text-center"> week streaming Movies </h1>
                <div className="flex flex-wrap justify-center">
                    {streamingMovies ? (
                        streamingMovies.map((movie: MovieData) => (
                            <div
                                key={movie.id}
                                className="m-8 shadow-sm rounded-md overflow-hidden"
                            >
                                <div className="w-[260px]  grid grid-cols-4 h-[400px] relative overflow-hidden">
